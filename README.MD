...
> **Personal fork note:** I'm using this project to learn DNS tunneling techniques. My fork may include small experiments and notes as I work through the codebase.
>
> **Study notes so far:**
> - The ARQ (Automatic Repeat reQuest) layer is what gives MasterDnsVPN its stability edge over DNSTT under packet loss.
> - The ~5–7B header overhead is achieved by encoding session/sequence info very compactly — worth digging into the packet framing code.
> - The multipath resolver logic is in the routing module — next I want to trace how latency measurements feed into the adaptive routing decisions.
